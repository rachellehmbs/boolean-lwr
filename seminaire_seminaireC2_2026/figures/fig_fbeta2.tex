...
%    };
    ...
    { node[point] (tx3) {}
      ...
      child [grow=north west]{node[point] {} child[grow=west] { node[point] {} } child[grow= north west] { node[point] {} child[grow = west]{node[point] {} child[grow= west] { node[point] {} child { node[point] {} } child {node[point] {}}} }} }
          ...
          child[grow=north west,shift={(0,-.15)}]
    { node[point]  {} child[grow= north west] { node[point] {} } 
    };
...
;
    \node[ipoint] at (x2) {} child[grow= west,shift={(0,-0.15)}]
    { node[point] {}
    };
    %
%    \node[ipoint] at (x3) {} 
...
%%%%%%%%%%%%
   ...
   \node[ipoint] at (x20) {} child[grow= east,shift={(0,-.2)}]
    ...
    \node[color=vert3] at ([yshift = -3.5mm] tx0.south) {\footnotesize $x_0$};
    \node[point,color=vert3] at (tx0) {}; 

    \node[color=vert3] at ([yshift = -3.5mm] tx1.south) {\footnotesize $x_1$};
        \node[point,color=vert3] at (tx1) {}; 

    \node[color=vert3] at ([yshift = -3.5mm] tx2.south) {\footnotesize $x_2$};
        \node[point,color=vert3] at (tx2) {}; 

            \node[point,color=vert3] at (tx3) {}; 
     %       \node[point,color=vert3] at (tx4) {}; 
           \node[point,color=vert3] at (x1) {}; 
            \node[point,color=vert3] at (x2) {};
            \node[point,color=rouge3] at (x3) {};
                                                
\node[color=rouge3] at ([yshift = -3mm] x3.south)  {\footnotesize $x_{\cipherlength-1}$};





    \node at (5,-2) {\footnotesize Graph of an \bleu{exceptional} $h_\beta$}; 
  \end{tikzpicture}
